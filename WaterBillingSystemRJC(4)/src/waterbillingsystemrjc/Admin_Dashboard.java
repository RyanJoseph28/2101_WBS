...
import java.util.Vector;
   ...
   private void syncBDDataToBSandGR() {
        ...
        BSTotalAmountDueTF.setText(totalAmountDue);
        GRTotalAmountDueTF.setText(totalAmountDue);
        PTotalAmountDueTF.setText(totalAmountDue);
    }
   ...
   private void syncBSDataToGR() {
    ...
    private void initComponents() {
        ...
        PTotalAmountDueTF = new javax.swing.JTextField();
...
try {
    ...
    private void PTotalAmountDueTFActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_PTotalAmountDueTFActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_PTotalAmountDueTFActionPerformed

    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
 
    String accountNo = PAccountNoTF.getText();  
    String accountName = PAccountNameTF.getText(); 
    String totalAmountDue = PTotalAmountDueTF.getText(); 
    ...
    String query1 = "INSERT INTO clientpayment (Account_No, Account_Name, Total_Amount_Due, Payment_Method) VALUES (?, ?, ?, ?)";
    String query2 = "INSERT INTO clientpaymentsales (Account_No, Account_Name, Total_Amount_Due, Payment_Method) VALUES (?, ?, ?, ?)";
    ...
    try {
        ...
        if (rowsAffected1 > 0 && rowsAffected2 > 0) {
            JOptionPane.showMessageDialog(this, "Payment details saved successfully to both tables.", "Success", JOptionPane.INFORMATION_MESSAGE);
            
            PArea.setText(PArea.getText() + "\n PAYMENT");
    ...
    private javax.swing.JTextField PTotalAmountDueTF;
