...
import java.util.Vector;
   ...
   private void syncBSDataToGR() {
    ...
    private void initComponents() {
        ...
        jPanel6.add(BSAddToReceipt, new org.netbeans.lib.awtextra.AbsoluteConstraints(930, 533, -1, 20));
...
try {
    ...
    int confirm = JOptionPane.showConfirmDialog(
        this,
        "Are you sure you want to update the details for Account Number: " + accountNo + "?",
        "Confirm Update",
        JOptionPane.YES_NO_OPTION,
...
try {
    ...
    private void MRAddToReceiptActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MRAddToReceiptActionPerformed
       try {
    // Assuming syncMRDataToOtherTabs() performs some synchronization tasks
    syncMRDataToOtherTabs(); 

    // Display a success prompt to the user
    JOptionPane.showMessageDialog(
        this, 
        "Data synchronization completed successfully.\nThe details have been added to the receipt.", 
        "Success", 
    ...
    JOptionPane.showMessageDialog(
        this, 
        "An error occurred during synchronization: " + ex.getMessage(), 
        "Error", 
        JOptionPane.ERROR_MESSAGE
    );
}
    ...
    try (Connection conn1 = DBConnection.getConnection(); 
        ...
        try (PreparedStatement preparedStatementCheck = conn1.prepareStatement(checkAccountQuery)) {
            ...
            try (PreparedStatement preparedStatement1 = conn1.prepareStatement(sqlGeneratedReceipt);
                ...
                // Set parameters for the first database connection
                ...
                // Set parameters for the second database connection
                ...
                if (rowsInserted1 > 0 && rowsInserted2 > 0) {
                    int confirmation = JOptionPane.showConfirmDialog(
                        null,
                        "The receipt has been prepared for Account No: " + accountNo + ".\nAre you sure you want to send it to the client?",
                        "Confirm Receipt",
                        JOptionPane.YES_NO_OPTION,
                        JOptionPane.QUESTION_MESSAGE
                    );
                    ...
                    if (confirmation == JOptionPane.YES_OPTION) {
                        ...
                        JOptionPane.showMessageDialog(null, "Receipt sending was canceled.", "Action Canceled", JOptionPane.INFORMATION_MESSAGE);
                    }
                } else {
...
try {
    ...
    if (confirmation != JOptionPane.YES_OPTION) {
        JOptionPane.showMessageDialog(this, "Payment process canceled.", "Action Canceled", JOptionPane.INFORMATION_MESSAGE);
        return;
    }
    ...
    try (Connection con = DriverManager.getConnection(dbUrl, dbUser, dbPassword)) {
        ...
        if (rowsAffected1 > 0 && rowsAffected2 > 0) {
            ...
            JOptionPane.showMessageDialog(this, "Payment successfully recorded!", "Success", JOptionPane.INFORMATION_MESSAGE);
        } else {
